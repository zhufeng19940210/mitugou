...
#define CHANGEVIEW_HEIGHT  (SCREENHEIGHT-64-NavBarPadding)
#define NavBarPadding      ((SCREENHEIGHT==812)?24:0)
#define HomeBarPadding     ((SCREENHEIGHT==812)?34:0)
...
-(void)createNavigation{
    UIView * navigationView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 64+NavBarPadding)];
    navigationView.backgroundColor = MainThemeColor;
    [self addSubview:navigationView];
    
    //标题
    _titleLB = [[UILabel alloc]initWithFrame:CGRectMake(0, 20+NavBarPadding, SCREENWIDTH, 44)];
    _titleLB.text = @"身份检测";
//    _titleLB.adjustsFontSizeToFitWidth = YES;
    ...
    [btn setImage:[UIImage imageNamed:@"nav_btn_close"] forState:UIControlStateNormal];
    
    [navigationView addSubview:btn];
    
    btn.sd_layout
    .centerYEqualToView(_titleLB)
    .rightSpaceToView(navigationView, 10)
    .widthIs(40)
    .heightIs(40);
...
-(void)createView{
    _changedView = [[UIView alloc]initWithFrame:CGRectMake(0, 64+NavBarPadding, SCREENWIDTH, CHANGEVIEW_HEIGHT)];
    _changedView.backgroundColor = MainThemeColor;
...
-(void)creatBeginView{
    ...
    //背景图
    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(SCREENWIDTH/12, (CHANGEVIEW_HEIGHT-HomeBarPadding)/13, SCREENWIDTH/12*10, (CHANGEVIEW_HEIGHT-HomeBarPadding)/13*9)];
    bgView.backgroundColor = [UIColor whiteColor];
    bgView.layer.cornerRadius = 8.0;
    [_changedView addSubview:bgView];
    
    //图像
    UIImageView * photoImg = [[UIImageView alloc]initWithFrame:CGRectMake(SCREENWIDTH/10*2, (CHANGEVIEW_HEIGHT-HomeBarPadding)/16*2, SCREENWIDTH/10*6, (CHANGEVIEW_HEIGHT-HomeBarPadding)/16*8)];
    ...
    UIImageView *promptView = [[UIImageView alloc]initWithFrame:CGRectMake(SCREENWIDTH/16*2, (CHANGEVIEW_HEIGHT-HomeBarPadding)/13*8, SCREENWIDTH/16*12, (CHANGEVIEW_HEIGHT-HomeBarPadding)/13*2)];
    ...
    beginBtn.frame = CGRectMake(SCREENWIDTH/12, (CHANGEVIEW_HEIGHT-HomeBarPadding)/13*11, SCREENWIDTH/12*10, SCREENWIDTH/8);
    ...
    label.center = CGPointMake(SCREENWIDTH/2, CHANGEVIEW_HEIGHT-HomeBarPadding-20);
    label.text = @"应用版本号:V1.0.0";
...
-(void)createSucceedView:(UIImage *)img{
    _titleLB.text = @"检测结果";
    UIImageView * photoImgView = [[UIImageView alloc]initWithFrame:CGRectMake(SCREENWIDTH/4, (CHANGEVIEW_HEIGHT-HomeBarPadding)/6, SCREENWIDTH/2, SCREENWIDTH/2/3*4)];
    photoImgView.image = img;
    photoImgView.layer.cornerRadius = photoImgView.frame.size.height/15;
    photoImgView.layer.masksToBounds = YES;
    [_changedView addSubview:photoImgView];
    
    UIImageView *viewBorder = [[UIImageView alloc]initWithFrame:CGRectMake(SCREENWIDTH/4-1, (CHANGEVIEW_HEIGHT-HomeBarPadding)/6-1, SCREENWIDTH/2+2, SCREENWIDTH/2/3*4+2)];
...
-(void)creatBtn{
    ...
    againBtn.frame = CGRectMake(SCREENWIDTH/9, CHANGEVIEW_HEIGHT-SCREENWIDTH/8-30-HomeBarPadding, SCREENWIDTH/9*3, SCREENWIDTH/8);
    ...
    quitBtn.frame = CGRectMake(SCREENWIDTH/9*5, againBtn.frame.origin.y, SCREENWIDTH/9*3, SCREENWIDTH/8);
